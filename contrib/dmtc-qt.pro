...
RESOURCES += src/qt/dmtc.qrc src/qt/dmtc_locale.qrc

TRANSLATIONS += src/qt/locale/dmtc_bg.ts \
                src/qt/locale/dmtc_de.ts \
                src/qt/locale/dmtc_en.ts \
                src/qt/locale/dmtc_es.ts \
                src/qt/locale/dmtc_fi.ts \
                src/qt/locale/dmtc_fr.ts \
                src/qt/locale/dmtc_it.ts \
                src/qt/locale/dmtc_ja.ts \
                src/qt/locale/dmtc_pl.ts \
                src/qt/locale/dmtc_pt.ts \
                src/qt/locale/dmtc_ru.ts \
                src/qt/locale/dmtc_sk.ts \
                src/qt/locale/dmtc_sv.ts \
                src/qt/locale/dmtc_vi.ts \
                src/qt/locale/dmtc_zh_CN.ts \
                src/qt/locale/dmtc_zh_TW.ts
