...
This means one can have an always-on dmtcd instance running, and another local dmtcd/dmtc-qt instance which connects to this node and receives blocks from it.
