Contributing to DMTC Core
============================

The DMTC Core project operates an open contributor model where anyone is
...
The following applies to code changes to the DMTC Core project, and is not to be
confused with overall DMTC Network Protocol consensus changes.

Whether a pull request is merged into DMTC Core rests with the project merge
...
Patches that change DMTC consensus rules are considerably more involved than
...
spread out over GitHub,email). The following
...
The project leader is the release manager for each DMTC Core release.
