...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Dmtc features */
		{ "dmtc", "debug", &debug, true, true, false },
		{ "dmtc", "masternode", &masternode, true, true, false },
		{ "dmtc", "allocatefunds", &allocatefunds, true, true, false },
		{ "dmtc", "fundmasternode", &fundmasternode, true, true, false },
		{"dmtc", "listmasternodes", &listmasternodes, true, true, false},
        {"dmtc", "getmasternodecount", &getmasternodecount, true, true, false},
        {"dmtc", "masternodeconnect", &masternodeconnect, true, true, false},
        {"dmtc", "masternodecurrent", &masternodecurrent, true, true, false},
        // {"dmtc", "masternodedebug", &masternodedebug, true, true, false},
        {"dmtc", "startmasternode", &startmasternode, true, true, false},
        {"dmtc", "createmasternodekey", &createmasternodekey, true, true, false},
        {"dmtc", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"dmtc", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"dmtc", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"dmtc", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"dmtc", "getmasternodescores", &getmasternodescores, true, true, false},
        //{"dmtc", "mnbudget", &mnbudget, true, true, false},
        //{"dmtc", "preparebudget", &preparebudget, true, true, false},
        //{"dmtc", "submitbudget", &submitbudget, true, true, false},
        //{"dmtc", "mnbudgetvote", &mnbudgetvote, true, true, false},
        //{"dmtc", "getbudgetvotes", &getbudgetvotes, true, true, false},
        //{"dmtc", "getnextsuperblock", &getnextsuperblock, true, true, false},
        //{"dmtc", "getbudgetprojection", &getbudgetprojection, true, true, false},
        //{"dmtc", "getbudgetinfo", &getbudgetinfo, true, true, false},
        //{"dmtc", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        //{"dmtc", "mnfinalbudget", &mnfinalbudget, true, true, false},
        //{"dmtc", "checkbudgets", &checkbudgets, true, true, false},
        {"dmtc", "mnsync", &mnsync, true, true, false},
        {"dmtc", "spork", &spork, true, true, false},
        {"dmtc", "getpoolinfo", &getpoolinfo, true, true, false},
...
#ifdef ENABLE_WALLET
        // {"dmtc", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use dmtcd, or the -server option to dmtc-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> dmtc-cli " + methodname + " " + args + "\n";
}
