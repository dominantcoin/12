...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Dmtc Core dmtc-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  dmtc-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded dmtc transaction") + "\n" +
                               "  dmtc-tx [options] -create [commands]   " + _("Create hex-encoded dmtc transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded dmtc transaction
