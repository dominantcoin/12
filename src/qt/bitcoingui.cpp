                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("DMTC Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a DMTC address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and dmtc: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zDMC"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About DMTC Core"), this);
    aboutAction->setStatusTip(tr("Show information about DMTC Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for DMTC"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your DMTC addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified DMTC addresses"));
    ...
    openAction->setStatusTip(tr("Open a DMTC: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the DMTC Core help message to get a list with possible DMTC command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("DMTC Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to DMTC network", "", count));
}
...
{
    QString strTitle = tr("DMTC Core"); // default title
