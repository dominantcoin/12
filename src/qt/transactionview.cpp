                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Dmc from zDmc"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zDmc"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zDmc));
