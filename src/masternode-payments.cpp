...
const std::string TREASURY_PAYMENT_ADDRESS("D6w7dwqiqdTCknqa3ZEnCC6UZ2eSv6TXxe");
const std::string CHARITY_PAYMENT_ADDRESS("D6w7dwqiqdTCknqa3ZEnCC6UZ2eSv6TXxe");

const std::string TREASURY_PAYMENT_ADDRESS_TESTNET("D6w7dwqiqdTCknqa3ZEnCC6UZ2eSv6TXxe");
const std::string CHARITY_PAYMENT_ADDRESS_TESTNET("D6w7dwqiqdTCknqa3ZEnCC6UZ2eSv6TXxe");
