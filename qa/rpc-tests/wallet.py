...
#   c) node1 mines 32 blocks, so now node 0 has 60001dmc, node 1 has 4250dmc, node2 has none.
#   d) node0 sends 601 dmc to node2, in two transactions (301 dmc, then 300 dmc).
