...
## Definition
Dmtc's equivalent to Bitcoin’s Proof of Work is Proof of Stake, and instead of Bitcoin’s mining, Dmtc has staking. Rather than needing vast amounts of computer power to secure the network,  “Coin Age" enables Dmtc's security protocols. We find the Coin Age by multiplying the number of coins by the “age” of these coins, i.e. the amount of time between now and the last transaction using said coins.
...
### Example
Imagine today is Monday, and I receive 1000 DMTC from Alice. On Tuesday, that UTXO has a Coin Age of 24 hours. Now, let's say I want to send 200 DMTC to Bob, but since I am sending my 1000 Dmtc UTXO, my Coin Age resets, and I get a new UTXO that is worth 800 DMTC.
...
### Example
My wallet creates a stake with 10 000 DMTC, (essentially spending 10 000 DMTC) getting back 10 000 + 456 DMTC, at this point 10 456 coins are "immature" for 20 blocks, only after that am I able to spend the coins that were used to create the Coin Stake.