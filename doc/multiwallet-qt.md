...
In order to support loading of multiple wallets in dmtc-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is dmtc.cpp.
...
Changes to dmtc.cpp
----------------------
dmtc.cpp is the entry point into dmtc-qt, and as such, will require some minor modifications to provide hooks for
